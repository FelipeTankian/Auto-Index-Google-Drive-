...
3\. Copy the \*\*Folder ID\*\*. It is the long string of letters and numbers right after `folders/` (for example: `https://drive.google.com/drive/folders/**1aBcD2eFgH3iJkL4mNoP5qRsT6uVwXyZ**`).
